...
public class HenViewPrinterProvider {
    ...
    public HenViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = HenDisplayUtil.dp2px(100, rootView.getResources());
    ...
    public void showLogView() {
        ...
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, HenDisplayUtil.dp2px(160, rootView.getResources()));

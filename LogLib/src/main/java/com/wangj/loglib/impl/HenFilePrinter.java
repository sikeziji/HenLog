 ...
 */
public class HenFilePrinter implements HenLogPrinter {
    private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor();
    private final String logPath;
    private final long retentionTime;
    private LogWriter writer;
    private volatile PrintWorker worker;
    private static HenFilePrinter instance;
     ...
     */
    public static synchronized HenFilePrinter getInstance(String logPath, long retentionTime) {
        if (instance == null) {
            instance = new HenFilePrinter(logPath, retentionTime);
        }
        return instance;
    }


    private HenFilePrinter(String logPath, long retentionTime) {
    ...
    public void print(@NonNull HenLogConfig config, int level, String tag, @NonNull String printString) {
        ...
        worker.put(new HenLogMo(timeMillis, level, tag, printString));
    }

    private void doPrint(HenLogMo logMo) {
    ...
    private class PrintWorker implements Runnable {
        ...
        private BlockingQueue<HenLogMo> logs = new LinkedBlockingQueue<>();
